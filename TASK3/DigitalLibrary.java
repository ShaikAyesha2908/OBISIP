...
public class Digital_Library_Management {
    ...
    public void admin_login()
    {
        ...
        loginto.put("Satyajit",123);
        loginto.put("Satya",20026);
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Satya",13579);
        loginto.put("Satyajit",20026);
        loginto.put("Rahul",12345);
        loginto.put("sswain",24680);
        loginto.put("bapu",11111);
    ...
    public void borrows()
    {
        ...
        {
            System.out.println("\n" + "You have Already Issued a Book..! Please Kindly Return The Issued book To Issue A New One... ");
        }
        else
        {
            System.out.println("\n" + "Invalid Book Number or Book is not Available In The Library...");
        }
        user_mainpage();
    }
    ...
    public void returns()
    {
        ...
        if(book_database_server().containsKey(issues))
        {
            ...
            {
                issues = 0;
                System.out.println("\n" + "Book Returned Successfully Thankyou Visit Again ");
            }
            else{
            ...
            System.out.println("\n" + "You don't have any issued any exix=sting book.!!!");
        }
        user_mainpage();
    }
